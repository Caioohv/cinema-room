...
Shows available rooms, seats and lets you play with them

### Backend

Made using ElysiaJS, Socket.IO, MongoDB and RabbitMQ

### Reverse Proxy

Made using nginx, to route requests between frontend and backend apps
